...
export class ImportExportSchema {
  ...
  generate() {
    ...
    // ─────────────────────────────────────────────
    // SECCIONES COMPLETAS (NO SE ELIMINA NADA)
    // ─────────────────────────────────────────────
...
nohup expdp \\'/ as sysdba \\' TABLES=${owner}.${tablesForCommand} 
...
TABLES=${owner}.${tablesForCommand} 
TABLE_EXISTS_ACTION=REPLACE DIRECTORY=${dirName} 
